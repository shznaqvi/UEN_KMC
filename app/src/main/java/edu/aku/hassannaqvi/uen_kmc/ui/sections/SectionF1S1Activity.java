...
import edu.aku.hassannaqvi.uen_kmc.databinding.ActivitySectionF1S1Binding;

public class SectionF1S1Activity extends AppCompatActivity {
    private static final String TAG = "SectionF1S1Activity";
    ActivitySectionF1S1Binding bi;
    private DatabaseHelper db;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        bi = DataBindingUtil.setContentView(this, R.layout.activity_section_f1_s1);
        bi.setForm(form);

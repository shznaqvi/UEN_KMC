...
/*    const val SQL_CREATE_VERSIONAPP = ("CREATE TABLE "
    ...
    const val SQL_CREATE_DISC_FORMS = ("CREATE TABLE "
            + DISCFormTable.TABLE_NAME + "("
            + DISCFormTable.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + DISCFormTable.COLUMN_PROJECT_NAME + " TEXT,"
            + DISCFormTable.COLUMN_UID + " TEXT,"
            + DISCFormTable.COLUMN_USERNAME + " TEXT,"
            + DISCFormTable.COLUMN_SYSDATE + " TEXT,"
            + DISCFormTable.COLUMN_ISTATUS + " TEXT,"
            + DISCFormTable.COLUMN_DEVICEID + " TEXT,"
            + DISCFormTable.COLUMN_DEVICETAGID + " TEXT,"
            + DISCFormTable.COLUMN_SYNCED + " TEXT,"
            + DISCFormTable.COLUMN_SYNCED_DATE + " TEXT,"
            + DISCFormTable.COLUMN_APPVERSION + " TEXT,"
            + DISCFormTable.COLUMN_DIST_CODE + " TEXT,"
            + DISCFormTable.COLUMN_DF + " TEXT"
            + " );"
            )
